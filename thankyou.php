...
/*==================================== Below variables to review START ========================================*/
	...
	// define('DB_USERNAME','combri_sunbuilde'); 
	// define('DB_PASSWORD','G[8$#CBwQ_=k'); 
	// define('DB_DATABASE','combri_dbformsunbuilders');
	// // do not Edit below
	...
	// $email_to3="extraemail@example.in";
	...
	$captcha_privatekey = '6Lfr8H0iAAAAAO-vG92_v5srBpKqrSqMgjcHOEQO';
...
$brochure_link='https://thekimanatowers.com/pdf/THE-KIMANA-TOWERS-LOOK-BOOK.pdf';
if(!empty($_POST['brochure_link']))
$brochure_link=$_POST['brochure_link'];

$planbook_link='https://thekimanatowers.com/pdf/the-kimana-towers-plan-book.pdf';
if(!empty($_POST['planbook_link']))
$planbook_link=$_POST['planbook_link'];
...
"The_Kimana_Towers_Enquiry_Form" => "Thankyou for registering your interest with The Kimana Towers.<br>Our team shall get in touch with you within 24 hours.",	
...
"The_Kimana_Towers_Request_A_Callback" => "Thankyou for registering your interest with The Kimana Towers.<br>Our team shall get in touch with you within 24 hours.",
"Download_Plan_Book" => "Awesome!<br>Thank you for your interest.<br>The requested brochure would have just landed in the inbox of your registered mail address. Given the quirky mailing algorithm, do check your spam if our mail has missed your inbox.",
...
"The_Kimana_Towers_Request_A_Callback" => "Thankyou for registering your interest with The Kimana Towers.<br>Our team shall get in touch with you within 24 hours.",
"Download_Plan_Book" => "Awesome!<br>Thank you for your interest.<br><a href='$planbook_link' target='_blank'>Click Here to to refer and download your requested brochure.</a>",	
...
if(!$captcha_response->success || (($name=="" || $email=="" || $contact_no=="") && $type_of_form!="Newsletter"))
{
	...
	// echo "Type of Form: $type_of_form<br>";
	// echo "Captcha Success: ";
	// echo $captcha_response->success ? "true" : "false";
}
else
{
...
// //       	 echo "⚠️ Duplicate entry detected, skipping...";
// 			// you can `continue;` or log it here
//     	} else {
