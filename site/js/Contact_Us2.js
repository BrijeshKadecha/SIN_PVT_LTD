...
{
    document.querySelector('#Contact_Us #error_data').innerHTML = '* Please Enter Company Name.';
...
{
    company_name.style.borderColor="";
}

var project_type = document.querySelector('#Contact_Us #project_type');
if(project_type.value=='')
{
    document.querySelector('#Contact_Us #error_data').innerHTML = '* Please Select Project Type.';
    project_type.style.borderColor="red";
    project_type.focus();
    return false;
}
else
{
    project_type.style.borderColor="";
}
